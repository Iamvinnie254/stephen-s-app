        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((proj, i) => (
            <FadeIn key={proj.title} delay={i * 0.08}>
              <div className="group relative bg-white/3 border border-white/8 rounded-2xl overflow-hidden hover:border-white/15 transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/40">
                {/* Gradient top */}
                <div
