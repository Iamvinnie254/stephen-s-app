...
const Portfolio = () => {
  return (
    <div className="justify-between items-center max-w-screen-xl px-5 py-8 md:mx-auto mx-3">
      <div className="pt-10">
        <h2
          className="text-emerald-700 text-center font-semibold md:text-xl"
          data-aos="fade-out"
        >
          My Projects
        </h2>
        <h1
          className="md:text-3xl text-2xl text-center font-semibold pt-2"
          data-aos="fade-out"
        >
          These are some of my recent projects...
        </h1>
        <p className="pt-2 text-center font-light" data-aos="fade-out">
        ...
        <div
          className="p-5 flex flex-col md:flex-row gap-2 items-center justify-center"
          data-aos="fade-out"
        >
          <button className="bg-purple-600 cursor-pointer text-gray-800 shadow-2xl hover:bg-purple-700 p-2 mt-3 rounded-full">
            *All Projects*
          </button>
          <button className="p-2 mt-3 rounded-full cursor-pointer bg-white shadow-2xl">
      ...
      <div className="flex justify-center pt-10 mt-5 ">
        <Link
          to={"https://github.com/Iamvinnie254"}
          className=""
          target="_blank"
        >
